            ...
            <table class="table table-striped table-bordered">
                ...
                <tbody>
                    <?php while ($row = mysqli_fetch_assoc($result)) { ?>
                        <tr>
                            <td><img src="/unitop/backend/lesson/school/project_pizza/<?php echo $row['Anh']; ?>" alt="Ảnh sản phẩm" class="product-image"></td>
                            ...
                            <td>
                               ...
                               <a href="/unitop/backend/lesson/school/project_pizza/admin/process/delete_samphamsize.php?id=<?php echo $row['id']; ?>" class="btn btn-delete btn-sm" onclick="return confirm('Bạn có chắc chắn muốn xóa giá sản phẩm này?');"><i class="fa-solid fa-trash"></i> Xóa</a>
                            </td>
                        </tr>
                    <?php } ?>
                </tbody>
    ...
    <div class="modal fade" id="editPriceModal" tabindex="-1">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="/unitop/backend/lesson/school/project_pizza/admin/process/update_process.php" method="post" enctype="multipart/form-data">
