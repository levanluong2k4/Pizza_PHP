                    ...
                    <?php while ($row = mysqli_fetch_assoc($result)) { ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="/unitop/backend/lesson/school/project_pizza/admin/process/delete_size.php?id=<?php echo $row['MaSize']; ?>" class="btn btn-delete btn-sm" onclick="return confirm('Bạn có chắc chắn muốn xóa size này?');"><i class="fa-solid fa-trash"></i> Xóa</a>
                            </td>
                        </tr>
                    <?php } ?>
                </tbody>
    ...
    <div class="modal fade" id="editSizeModal" tabindex="-1">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="/unitop/backend/lesson/school/project_pizza/admin/process/edit_size.php" method="post">
