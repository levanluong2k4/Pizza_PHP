...
?>
            <tr>
                ...
                <td><img src="/unitop/backend/lesson/school/project_pizza/<?php echo $value["Anh"] ?>" alt="" width="50px" height="auto"></td>

                <td><a href="update_product.php?ma=<?php echo $value["id"] ?>">Sữa </a></td>
                <td><a href="/unitop/backend/lesson/school/project_pizza/admin/process/delete.php?id=<?php echo $value["id"]?>"
