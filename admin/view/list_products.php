                ...
                <tbody>
                    <?php while ($row = mysqli_fetch_assoc($result)) { ?>
                        <tr>
                            ...
                            <td><img src="../../<?php echo $row['Anh']; ?>" alt="Ảnh sản phẩm" class="product-img"></td>
                            <td>
                                <a href="edit_product.php?id=<?php echo $row['MaSP']; ?>" class="btn btn-edit btn-sm me-2"><i class="fa-solid fa-edit"></i> Sửa</a>
                                <a href="../process/delete_product.php?id=<?php echo $row['MaSP']; ?>" class="btn btn-delete btn-sm" onclick="return confirm('Bạn có chắc chắn muốn xóa sản phẩm này?');"><i class="fa-solid fa-trash"></i> Xóa</a>
                            </td>
                        </tr>
                    <?php } ?>
                </tbody>
