            ...
            <div class="combo-body">
                <?php if (!empty($combos_id['Anh'])): ?>
                    <img src="./<?php echo $combos_id['Anh']; ?>" 
                         alt="<?php echo htmlspecialchars($combos_id['Tencombo']); ?>" 
                         class="combo-image">
                <?php endif; ?>
                ...
                <div id="comboDetails" class="combo-details">
                    ...
                    ?>
                        <div class="combo-item" 
                             ...
                             data-maloai="<?php echo $item['MaLoai']; ?>"
                ...
                <a href="./datban/info_datban.php?combo_id=<?php echo $combo_id ?>&loaidatban=tiec" class="btn btn-order-combo mt-3" >
...
<div class="modal fade" id="modalChangeProduct" tabindex="-1" aria-labelledby="modalChangeProductLabel" aria-hidden="true">
            ...
            <div class="modal-body">
                <div class="current-product-info mb-4 p-3 bg-light rounded">
                    ...
                    <div class="d-flex align-items-center">
                        <img id="currentProductImage" src="" alt="" class="rounded me-3" style="width: 80px; height: 80px; object-fit: cover;">
                        <div>
        ...
        $.ajax({
            ...
            success: function(res) {
                ...
                if(res.success && res.products.length > 0){
                    ...
                    $('#productList').html('<div class="col-12"><p class="text-muted text-center">Không có sản phẩm thay thế nào.</p></div>');
                }
            },
            error: function(xhr, status, error) {
                $('#loadingProducts').addClass('d-none');
                $('#productList').html('<div class="col-12"><p class="text-danger text-center">Lỗi khi tải sản phẩm: ' + error + '</p></div>');
